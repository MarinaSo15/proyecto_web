...
## 2. Contenido multimedia a buscar
* [ ] Buscar foto de portada (paisaje espectacular).
* [ ] Buscar 4 fotos de animales/parques para la galeria.
* [ ] Buscar enlace de YouTube sobre viajes sostenibles.

## 3. Colores e ideas
* Color principal: Verde Selva (#2E8B57)
* Color secundario: Marron Tierra (#8B4513)
* Idea: Usar la frase "Lo que no te mata te hace mas fuerte, o engorda" en el pie de pagina.
